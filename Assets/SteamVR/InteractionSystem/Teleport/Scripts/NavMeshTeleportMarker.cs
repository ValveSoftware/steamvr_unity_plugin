...
namespace Valve.VR.InteractionSystem
{
	...
	public class TeleportNavMeshEditor : Editor
	{
		//-------------------------------------------------
		void OnEnable()
		{
			...
			{
				NavMeshTeleportMarker navMeshTeleportMarker = Selection.activeTransform.GetComponent<NavMeshTeleportMarker>();
				navMeshTeleportMarker.UpdateVisualsInEditor();
			}
		}
